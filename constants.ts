...
export const TRANSLATIONS = {
  en: {
    ...
    features: {
      ...
      scheduling: { title: "Smart Scheduling", desc: "Coordinate timings easily. We'll find the perfect slot that works for everyone's schedule." },
      qatta: { title: "Split the Qatta", desc: "No more awkward math at the Esteraha. Jamaa tracks who paid what and settles the Qatta fairly." },
      memories: { title: "Memories Saved", desc: "From the Kashta to the Chalet, all your photos and videos are saved automatically in one shared album." },
      travel: { title: "Travel Mode", desc: "Planning a road trip to AlUla or a flight to London? Manage flights, hotels, and itinerary in one place." }
    },
    cta: {
  ...
  ar: {
    ...
    features: {
      ...
      scheduling: { title: "تنسيق الوقت", desc: "نسقوا المواعيد بسهولة. بنلقى لكم الوقت اللي يناسب جدول الكل." },
      qatta: { title: "اقسم القطة", desc: "لا تشيل هم الحساب في الاستراحة. جمعة يحسب مين دفع ويسوي القطة بالعدل." },
      memories: { title: "ذكريات محفوظة", desc: "من الكشتة للشاليه، كل صوركم وفيديوهاتكم تنحفظ تلقائياً في ألبوم مشترك." },
      travel: { title: "وضع السفر", desc: "تخططون لروحة للعلا أو لندن؟ رتبوا الطيران، الفنادق، والجدول في مكان واحد." }
    },
    cta: {
